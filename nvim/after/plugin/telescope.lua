...
nvim.keymap.set('n', '<C-p>', function() builtin.find_files({ no_ignore = false, hidden = true }) end, {})
nvim.keymap.set('n', '<leader>f', function() builtin.find_files({ no_ignore = true, hidden = true }) end, {})
